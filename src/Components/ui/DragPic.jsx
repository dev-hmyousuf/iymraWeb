...
export const Dragpic = () => {
  return (
    <section className="relative grid min-h-screen rounded-lg w-full place-content-center overflow-hidden bg-gray-300">
      <h2 className="relative z-0 text-[20vw] font-black text-neutral-800 md:text-[200px]">
        IYMRA<span className="text-indigo-500">.</span>
      </h2>
      <Cards />
    </section>
  );
