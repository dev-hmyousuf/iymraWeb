...
const Feature = () => {
  return (
   <>
    ...
    <section
      id="features"
      className="container  px-4 space-y-6 bg-slate-50 py-8 md:py-12 lg:py-20  "
    >
      <div className="mx-auto justify-center flex max-w-4xl flex-col items-center space-y-4 text-center">
      ...
      <div className="mx-auto grid  gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              <h3 className="font-bold">Font Awesome Premium</h3>
              <p className="text-sm text-muted-foreground">
                Use the premium icons of Font Awesome Premium
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Authentication using FirebaseAuth.js and middlewares.
              </p>
            </div>
          </div>
        </div>
