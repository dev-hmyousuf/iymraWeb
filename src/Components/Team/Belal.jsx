          ...
          <div className="flex flex-wrap lg:items-center -m-8 lg:-m-14">
            <div className="w-full md:w-1/2 p-8 lg:p-14">
              <div className="relative max-w-max mx-auto lg:ml-auto lg:mr-0 overflow-hidden rounded-4xl">
                <img className="rounded-3xl transform hover:scale-105 transition ease-in-out duration-1000" src="https://scontent.fjsr11-1.fna.fbcdn.net/v/t39.30808-6/456281762_1077082147458887_7770224953184231442_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=127cfc&_nc_eui2=AeF_MvB6QzoE6hPbWFZQDtamaLLGzRnGyPBossbNGcbI8OhRY735Pa8_V80pcKC3terEItBOJK1Z-YSOCbBQq0_9&_nc_ohc=o5BhDPBioxYQ7kNvgFKVnAF&_nc_ht=scontent.fjsr11-1.fna&oh=00_AYDmaBcnq1430XQrZUJ_K8cK79JTBkfhd5_MHKEVx0nikg&oe=66CA5615" alt="" />
                  ...
                  <div className="overflow-hidden rounded-lg" style={{ backdropFilter: " blur(8px)" }}>
                    <div className="flex  sm:divide-x divide-y sm:divide-y-0 divide-gray-300">
                      <div className="w-full sm:w-1/3">
                        <a className="flex justify-center items-center h-full py-6 bg-white bg-opacity-80 hover:bg-opacity-60 transition ease-in-out duration-200" href="https://www.x.com/coderbelal29" target='_blank'>
                      ...
                      <div className="w-full sm:w-1/3">
                        <a className="flex justify-center items-center h-full py-6 bg-white bg-opacity-80 hover:bg-opacity-60 transition ease-in-out duration-200" href="https://www.facebook.com/devbelal10" target='_blank'>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                      ...
                      <div className="w-full sm:w-1/3">
                        <a className="flex justify-center items-center h-full py-6 bg-white bg-opacity-80 hover:bg-opacity-60 transition ease-in-out duration-200" href="https://www.linkedin.com/in/belal-uddin-99733229a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app&fbclid=IwY2xjawEyvwlleHRuA2FlbQIxMAABHa49kb_QC8pFlfg2z0_KfObfR3AtsOrf04-bPdCfrLCGfOFxLOYECVVtpw_aem_mKiC57j04mWZYiGp_doa7w" 
                         target='_blank' >
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
